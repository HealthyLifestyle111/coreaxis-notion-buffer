import routeConfig from './routes.json' with { type: 'json' };
...
/** Progressive elimination engine. Substantive health answers belong in Whole Practice. */
export function route(input = {}) {
  ...
  if (intent === 'mens') return result('oyster', 'Your starting point is the men’s vitality pathway.');
